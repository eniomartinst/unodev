...
describe('CardController - Operações CRUD de Cartões (Tarefa 3)', () => {
  ...
  describe('Criação de novos cartões (create)', () => {
    ...
    // Teste para: Criação de um novo cartão/carta com sucesso (HTTP 201)
    ...
    // Teste para: Tratamento de falha (Erro de banco/Service) durante a criação
  ...
  describe('Recuperação de informações (findAll)', () => {
    ...
    // Teste para: Listagem de todos os cartões disponíveis (HTTP 200)
    ...
    // Teste para: Tratamento de falha ao tentar listar os cartões
  ...
  describe('Atualização de detalhes (update)', () => {
    ...
    // Teste para: Atualização dos campos de um cartão específico (HTTP 200)
    ...
    // Teste para: Tratamento de exceção quando tenta atualizar cartão inexistente (NotFound)
  ...
  describe('Exclusão do banco de dados (delete)', () => {
    ...
    // Teste para: Deleção de um cartão e retorno de status No Content (HTTP 204)
    ...
    // Teste para: Tratamento de exceção ao tentar excluir cartão inexistente (NotFound)
