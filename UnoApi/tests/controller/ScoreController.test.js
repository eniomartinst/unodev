...
describe('ScoreController - Operações CRUD de Pontuação Histórica', () => {
  ...
  // Teste para: Criação de um novo registro de pontuação (HTTP 201)
  ...
  // Teste para: Listagem de todas as pontuações registradas no sistema (HTTP 200)
  ...
  // Teste para: Atualização do valor de uma pontuação específica (HTTP 200)
  ...
  // Teste para: Exclusão física de um registro de pontuação (HTTP 204)
